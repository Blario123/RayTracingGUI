...
void OpenGLView::initializeGL() {
    ...
    QSharedPointer<OpenGLItem> xArrow(new OpenGLItemArrow(glm::vec3(0.0f), OpenGLItemArrow::X));
    QSharedPointer<OpenGLItem> yArrow(new OpenGLItemArrow(glm::vec3(0.0f), OpenGLItemArrow::Y));
    QSharedPointer<OpenGLItem> zArrow(new OpenGLItemArrow(glm::vec3(0.0f), OpenGLItemArrow::Z));
    ...
    xArrow->setColor(glm::vec3(1.0, 0.0, 0.0));
    yArrow->setColor(glm::vec3(0.0, 1.0, 0.0));
    zArrow->setColor(glm::vec3(0.0, 0.0, 1.0));
